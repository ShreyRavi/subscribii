...
import {
  Grid, AppBar, Toolbar, Typography, Select, IconButton, MenuItem, Tooltip,
...
const Footer = ({
  data, darkMode, toggleDarkMode, timePeriod, setTimePeriod, visible,
}) => {
                ...
                visible
                  ...
                  : (
                    <Typography variant="caption">
                      ...
                      |
                      {' '}
                      <a className={classes.links} href="mailto:shreyastallamraju@gmail.com">Contact</a>
                      {' '}
                      |
                      {' '}
                      <a className={classes.links} href="https://github.com/ShreyRavi/subscribii/blob/master/PrivacyPolicy.md">Legal</a>
                    </Typography>
                  )
            }
